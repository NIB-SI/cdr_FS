...
runs in a second. The others read the Zenodo files from `data/` and are opt-in, because
reading gigabytes takes minutes:
...
same rules give **463 features → 175 after selection → 97 after the correlation stage → 95**.
