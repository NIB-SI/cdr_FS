...
trimmed_2_dir_rel = config['feature_selection']['trimmed_2_dir']
...
output_dir = os.path.join(base_path, trimmed_2_dir_rel)
feature_lists_dir = os.path.join(base_path, correlation_list_include_dir_rel)
...
print(f"All trimmed datasets (v2) saved to {output_dir}")